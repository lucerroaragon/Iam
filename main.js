...
const misTrabajos = [
  {
    ...
    detalle:
      "Este proyecto es de una pagina de turismo y vuelos, si estas interasdo en viajar en esta pagina podes comprar paquetes de vuelos hacia distintos al rededor del mundo",
  ...
  },
  {
    ...
    detalle:
      "Esta es una pagina de turismo sobre Noruega, si estas interesado en ir a Noruega y no sabes que lugares podrias visitar, esta es la pagina que tenes que visitar , te mostramos los tres lugares mas lindos y turisticos del pais para que puedas vistitarlos",
  ...
  },
  {
    ...
    detalle:
      "Esta una Landing Page de noticas deportivas, en esta pagina te contamos las ultimas noticias del deporte, los traspasos , los rumores , los fichajes , todo sobre deportes lo encontramos en esta pagina",
  ...
  },
  {
    ...
    detalle:
      "Esta es una Landing Page acerca de animales, donde tenemos informacion sobre productos y juguetes para cualquier mascota, hecho con unos colores llamativos para que se vea una pagina divertida para el cliente",
  ...
  },
  {
    ...
    detalle:
      "Esta es una Hero page, donde empece a usar mas herramientas que estuve aprediendo, en esta pagina podemos presentarnos y mostrar nuestros trabajos",
  ...
  },
  {
    ...
    detalle:
      "Esta en una pagina donde podemos ver un Login junto a una imagen con una frase, este fue el primer proyecto que hice y poco a poco fue aprendiendo mas",
...
const openModal = (proyectoToRender) => {
  ...
  modalContent.querySelector("#contModal_titulo").innerHTML =
    proyectoToRender.titulo;
  modalContent.querySelector("#contModal_detalle").innerHTML =
    proyectoToRender.detalle;
  modalContent.querySelector("#contModal_url_repositorio").href =
    proyectoToRender.url_repositorio ?? "#";
  modalContent.querySelector("#contModal_url_repositorio").target =
    proyectoToRender.url_repositorio ? "_blank" : "";
  modalContent.querySelector("#contModal_url_pagina").href =
    proyectoToRender.url_pagina ?? "#";
  modalContent.querySelector("#contModal_url_pagina").target =
    proyectoToRender.url_pagina ? "_blank" : "";
